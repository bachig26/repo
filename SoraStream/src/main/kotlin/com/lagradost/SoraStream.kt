...
import com.lagradost.SoraExtractor.invoke123Movie
import com.lagradost.SoraExtractor.invokeAnimes
import com.lagradost.SoraExtractor.invokeBollyMaza
import com.lagradost.SoraExtractor.invokeDbgo
import com.lagradost.SoraExtractor.invokeFilmxy
import com.lagradost.SoraExtractor.invokeFlixhq
import com.lagradost.SoraExtractor.invokeHDMovieBox
import com.lagradost.SoraExtractor.invokeIdlix
import com.lagradost.SoraExtractor.invokeKimcartoon
import com.lagradost.SoraExtractor.invokeMovieHab
import com.lagradost.SoraExtractor.invokeNoverse
import com.lagradost.SoraExtractor.invokeSeries9
import com.lagradost.SoraExtractor.invokeTwoEmbed
import com.lagradost.SoraExtractor.invokeUniqueStream
import com.lagradost.SoraExtractor.invokeVidSrc
import com.lagradost.SoraExtractor.invokeXmovies
import com.lagradost.cloudstream3.*
import com.lagradost.cloudstream3.LoadResponse.Companion.addTrailer
import com.lagradost.cloudstream3.metaproviders.TmdbProvider
import com.lagradost.SoraExtractor.invokeCrunchyroll
import com.lagradost.SoraExtractor.invokeFDMovies
import com.lagradost.SoraExtractor.invokeFlixon
import com.lagradost.SoraExtractor.invokeFwatayako
import com.lagradost.SoraExtractor.invokeGMovies
import com.lagradost.SoraExtractor.invokeKisskh
import com.lagradost.SoraExtractor.invokeLing
import com.lagradost.SoraExtractor.invokeM4uhd
import com.lagradost.SoraExtractor.invokeMovie123
import com.lagradost.SoraExtractor.invokeMoviesbay
import com.lagradost.SoraExtractor.invokeMoviezAdd
import com.lagradost.SoraExtractor.invokeRStream
import com.lagradost.SoraExtractor.invokeSmashyStream
import com.lagradost.SoraExtractor.invokeSoraStream
import com.lagradost.SoraExtractor.invokeTvMovies
import com.lagradost.SoraExtractor.invokeUhdmovies
...
//        "$tmdbAPI/tv/airing_today?api_key=$apiKey&region=" to "Airing Today TV Shows",
        ...
        "$tmdbAPI/movie/top_rated?api_key=$apiKey&region=US" to "Top Phim lẻ",
        "$tmdbAPI/tv/top_rated?api_key=$apiKey&region=US" to "Top Phim bộ",
        "$tmdbAPI/movie/upcoming?api_key=$apiKey&region=US" to "Phim sắp chiếu",
        "$tmdbAPI/discover/tv?api_key=$apiKey&with_original_language=ko" to "Phim hàn",
        "$tmdbAPI/tv/airing_today?api_key=$apiKey&with_keywords=210024|222243&sort_by=primary_release_date.desc" to "Anime hôm nay",
        "$tmdbAPI/tv/on_the_air?api_key=$apiKey&with_keywords=210024|222243&sort_by=primary_release_date.desc" to "Anime đang chiếu",
        "$tmdbAPI/discover/tv?api_key=$apiKey&with_keywords=210024|222243" to "Anime",
        "$tmdbAPI/discover/movie?api_key=$apiKey&with_keywords=210024|222243" to "Anime lẻ",
    )
